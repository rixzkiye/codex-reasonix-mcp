...
The current package version is `0.1.0-rc.1`. It requires the Reasonix ACP v1
...
codex mcp add reasonix-worker \
  ...
  -- npx -y codex-reasonix-mcp@0.1.0-rc.1
```

Run the non-model diagnostic before delegating work:

```sh
npx -y codex-reasonix-mcp@0.1.0-rc.1 doctor
```
